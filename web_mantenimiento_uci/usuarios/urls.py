...
urlpatterns = [
    ...
    path('usuarios/activo/<int:item_id>/',views.cambiar_activo_usuario,name='cambiar_activo_usuario'),
    ...
    path('incidencia/confirmar-prioridad/', views.confirmar_prioridad, name='confirmar_prioridad'),
